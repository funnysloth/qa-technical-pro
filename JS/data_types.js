...
/*
1. Спочатку відбувається операція піднесення до степеня 3**6б результатом буде 729
2. Далі відбувається приведення рядка в Number, в результаті чого отримаємо число 6
3. Потім відбувається операція додавання 6 + 729
Результат 735
*/
'6' + 3 ** 0;
